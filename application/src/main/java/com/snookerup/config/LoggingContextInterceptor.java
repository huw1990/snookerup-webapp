...
/**
 * Spring HandlerInterceptor which uses Message Diagnostic Context (MDC) to set the currently logged-in user on
 * the current thread, so that it can be included in all log messages.
 *
 * @author Huw
 */
