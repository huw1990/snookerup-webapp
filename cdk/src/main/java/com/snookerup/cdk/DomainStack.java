...
/**
 * CDK stack invoked by the {@link DomainApp}, responsible for serving our app behind the proper domain, rather than a
 * random AWS LB URL.
 *
 * @author Huw
 */
public class DomainStack extends Stack {
    ...
    public DomainStack(
        ...
        Network.NetworkOutputParameters networkOutputParameters = Network.getOutputParametersFromParameterStore(this,
